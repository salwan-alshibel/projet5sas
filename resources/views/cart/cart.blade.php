...
<div class="flex justify-center bg-gray-300">
    <div class="h-screen">
        <div class="max-w-md mx-auto mt-12 bg-gray-100 shadow-lg rounded-lg md:max-w-5xl">
            <div class="md:flex ">
                    ...
                    <div class="md:grid md:grid-cols-3 gap-2 ">
                        <div class="col-span-3 p-5">
                            ...
                            @foreach ($products as $product)
                                <div class="flex justify-between items-center mt-6 pt-6">
                                    <div class="flex items-center"> <img src="" width="60" class="rounded-full ">
                                        <div class="flex flex-col ml-3 w-80"> <span class="md:text-md font-medium">{{ $product['product']['title']}}</span> <span class="text-xs font-light text-gray-400">{{$product['priceXqty']}}€</span> </div>
                                    </div>
                            ...
                            <div class="flex justify-between items-center mt-6 pt-6 border-t">
                                <div class="flex justify-center items-end"> <span class="text-sm font-medium text-gray-400 mr-1">Sous total:</span> <span class="text-lg font-bold text-gray-800 "> {{$totalPrice}} € </span> </div>
                            </div>
                            <button class="h-12 w-full bg-blue-500 rounded focus:outline-none text-white hover:bg-blue-600">Etape suivante</button>
                            @endif
                        </div>
                        </div>
                    </div>
                        ...
                        <div class="md:grid md:grid-cols-3 gap-2 ">
                            <div class="col-span-2 p-5">
                                ...
                                @foreach ($products as $product)
                                    <div class="flex justify-between items-center mt-6 pt-6">
                                        <div class="flex items-center"> <img src="" width="60" class="rounded-full ">
                                            <div class="flex flex-col ml-3"> <span class="md:text-md font-medium">{{ $product['product']['title']}}</span> <span class="text-xs font-light text-gray-400">#41551</span> </div>
                                        </div>
