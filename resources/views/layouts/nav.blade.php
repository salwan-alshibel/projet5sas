    ...
    <div class="w-full container mx-auto flex flex-wrap md:flex-nowrap items-center justify-between border-b-2 border-solid border-black text-sm lg:text-base">
        ...
        <div class="nav-content hidden md:flex md:items-center md:flex-grow md:w-auto w-full order-4 md:order-2">
            <ul class="md:flex items-center justify-between pt-4 md:pt-0">
                ...
                <li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4" href="{{ route('dashboard') }}">Conditions de ventes</a></li>
                {{-- <li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4" href="{{ route('posts') }}">Paiement sécurisé</a></li> --}}
            </ul>
        </div>

        <div class="order-2 md:flex-grow">
            <ul class="flex items-center">
                <li>
                    <a class="inline-block relative no-underline hover:text-black" href="{{ route('home') }}" class="p-3">
                        <img id="logo-img" src="{{url('/images/iconfinder_Adventure_Map_2913095.png')}}" width="50" alt="Logo" class="mr-2 absolute -top-10 left-16">
        ...
        <div class="order-3 md:order-5">
            <a class="inline-block flex no-underline hover:text-black hover:underline py-2 pr-4" href="{{ route('cart') }}">
...
{{-- <script>
    //Button toggle in nav bar responsive:
