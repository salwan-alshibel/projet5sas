    ...
    <section id="presentations" class="pt-36">
        <div class="bg-white">
            <div class="md:flex">
                ...
                <div class="md:p-20">
                    <h1 class="uppercase tracking-wide text-sm text-black font-semibold text-3xl">Conditions de ventes</h1>
                    <div class="block mt-1 text-lg leading-tight font-medium text-black">Lorem ipsum dolor sit amet consectetur adipisicing elit.</div>
